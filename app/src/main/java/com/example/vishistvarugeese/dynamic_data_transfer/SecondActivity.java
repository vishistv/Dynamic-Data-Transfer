        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.hasChild(date)){
                    ...
                    for(int i = 0; i < 6; i++) {
                        ...
                        firebaseDatebase.getReference("titles").child("title" + (i + 1)).addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                listItems.add(item);
                                recyclerViewDataAdapter = new RecyclerViewDataAdapter(listItems, SecondActivity.this);
                    ...
                    Toast.makeText(SecondActivity.this,"Data Not Available",Toast.LENGTH_SHORT).show();
